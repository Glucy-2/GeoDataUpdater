...
download_dir="/usr/local/share/v2ray/"  # Replace with the destination folder path
...
if systemctl is-active --quiet v2ray.service; then
  echo "v2ray.service is running, restarting it"
  systemctl restart v2ray.service
else
  echo "v2ray.service is not running, starting it"
